...
class StagingDBLoadOperator(BaseOperator):
    ...
    : output format : SQL tables in DB
    """
    ...
    def execute(self, context) -> None:
        ...
        # improvement to be made: introduce concurrency
        for file in staging_files:
            ...
            # drop and create tmp table -> copy data into tmp table -> performs SCD type 2 operations
            # SCD type 2 operations: 1. Insert new records; 2. Insert Changed records; 3. Deactivates old records
            cursor.execute(
                """
